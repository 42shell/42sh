...
static void	init_keycaps(void)
{
	...
	if ((str = tgetstr("kD", NULL)))
		ft_strcpy((char *)&g_rl_keys[K_DEL], str);
	if ((str = tgetstr("kl", NULL)))
		ft_strcpy((char *)&g_rl_keys[K_LEFT], str);
	if ((str = tgetstr("kr", NULL)))
		ft_strcpy((char *)&g_rl_keys[K_RIGHT], str);
	if ((str = tgetstr("ku", NULL)))
		ft_strcpy((char *)&g_rl_keys[K_UP], str);
	if ((str = tgetstr("kd", NULL)))
		ft_strcpy((char *)&g_rl_keys[K_DOWN], str);
	if ((str = tgetstr("kh", NULL)))
		ft_strcpy((char *)&g_rl_keys[K_HOME], str);
}
